...
/**
 * Clase base para la interfaz con el panel de control de hosting Ferozo que contiene los métodos de conexión,
 * autenticación e interacción con el servidor.
 */
class ferozoBase {
    ...
    protected function solicitud($metodo,$ruta,$parametros=null,$cuerpo=null,$encabezados=null,$opciones=null) {
        ...
        if($metodo=='post') {
            ...
            if($cuerpo) {
                ...
                $opc[CURLOPT_POSTFIELDS]=http_build_query($parametros);
            }
        }
